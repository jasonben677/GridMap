...
namespace toinfiniityandbeyond.Utillity
{
	...
	public static class MyStyles
	{
		...
		public static readonly GUIStyle tileTextBoldLabel;
		...
		static MyStyles ()
		{
			...
			centerWhiteBoldLabel.normal.textColor = Color.white;

			tileTextBoldLabel = new GUIStyle(EditorStyles.whiteBoldLabel);
			tileTextBoldLabel.alignment = TextAnchor.MiddleCenter;
			tileTextBoldLabel.wordWrap = true;
			tileTextBoldLabel.normal.textColor = Color.white;
			tileTextBoldLabel.fontSize = 8;
			...
			centerBoldLabel.normal.textColor = Color.white;
